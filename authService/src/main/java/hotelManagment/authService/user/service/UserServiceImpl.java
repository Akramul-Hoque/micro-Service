...
import hotelManagment.authService.user.Dto.response.AddressResponse;
import hotelManagment.authService.user.Dto.response.UserResponse;
import hotelManagment.authService.user.entity.User;
import hotelManagment.authService.user.Dto.response.CommonResponse;
import hotelManagment.authService.user.repository.UserRepository;
